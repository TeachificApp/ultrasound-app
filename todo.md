...
- [x] Add the effective-Platform-Admin shared Quiz Card Library with saved presentation snapshots, cross-admin visibility, publish, flag/comment, resolve, delete, reopen, and export actions; migration `0072_quiz_card_library.sql` was applied without creating card records.
...
- [ ] Request one authorized real Study Group creation retry after the Railway MySQL schema repair; do not create a test group for verification.
