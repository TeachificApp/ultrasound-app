...
- [ ] Verify the GitHub-connected Railway runtime advances to the current Study Group insert mapping. The September 22 live error still exposed an older insert shape (`created_by` / legacy period column); do not create another group merely for diagnosis.
