...
- [x] Reconcile historical eligible paid course sales into the live payout ledger without sending funds: six Judith Buckland 25% shares ($7.49 each; $44.94 total) are now Pending and available for an administrator-controlled payout. Reconciliation is idempotent and does not transfer funds.
