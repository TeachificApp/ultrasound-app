...
- [x] Preserve the full uploaded/selected image composition in Social Post cards rather than cropping it; default new Social Post generation to one item; and make shared-library saving a deliberate administrator action after editing rather than an automatic generation side effect. Apply the additive Social Post theme compatibility migration to Railway MySQL without creating post records.
