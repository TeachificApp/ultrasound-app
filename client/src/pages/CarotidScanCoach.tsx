/*
  ...
  Based on: AIUM Practice Parameter for the Performance of an Ultrasound Examination of the Extracranial Cerebrovascular System (2021)
...
const views = [
  {
    ...
    tips: [
      { category: "Patient Positioning", text: "Supine position with the head supported and turned away from the side being examined. A pillow may be placed under the shoulders to improve neck exten" },
      { category: "Transducer Positioning", text: "Longitudinal and transverse planes, from clavicle to bifurcation" },
      { category: "What to Assess", text: "Plaque presence, location, extent, and characteristics. Vessel wall abnormalities." },
      { category: "Scanning Tip", text: "{\'tip_title\': \'Differentiating ICA from ECA\', \'tip_content\': \'The ECA has a higher-resistance wavefo" },
      { category: "Scanning Tip", text: "{\'tip_title\': \'Stenosis Measurement\', \'tip_content\': \'When measuring stenosis, the sample volume sho" }
    ],
  },
  {
    ...
    tips: [
      { category: "Patient Positioning", text: "Supine position with the head supported and turned away from the side being examined. A pillow may be placed under the shoulders to improve neck exten" },
      { category: "Transducer Positioning", text: "Longitudinal and transverse planes" },
      { category: "What to Assess", text: "Plaque at the bifurcation, flow division into ICA and ECA." },
      { category: "Scanning Tip", text: "{\'tip_title\': \'Differentiating ICA from ECA\', \'tip_content\': \'The ECA has a higher-resistance wavefo" },
      { category: "Scanning Tip", text: "{\'tip_title\': \'Stenosis Measurement\', \'tip_content\': \'When measuring stenosis, the sample volume sho" }
    ],
  },
  {
    ...
    tips: [
      { category: "Patient Positioning", text: "Supine position with the head supported and turned away from the side being examined. A pillow may be placed under the shoulders to improve neck exten" },
      { category: "Transducer Positioning", text: "Longitudinal and transverse planes, from origin to as far distally as possible" },
      { category: "What to Assess", text: "Plaque presence, location, extent, and characteristics. Stenosis assessment." },
      { category: "Scanning Tip", text: "{\'tip_title\': \'Differentiating ICA from ECA\', \'tip_content\': \'The ECA has a higher-resistance wavefo" },
      { category: "Scanning Tip", text: "{\'tip_title\': \'Stenosis Measurement\', \'tip_content\': \'When measuring stenosis, the sample volume sho" }
    ],
  },
  {
    ...
    tips: [
      { category: "Patient Positioning", text: "Supine position with the head supported and turned away from the side being examined. A pillow may be placed under the shoulders to improve neck exten" },
      { category: "Transducer Positioning", text: "Longitudinal plane, with identification of a branch if possible" },
      { category: "What to Assess", text: "Flow direction and waveform characteristics to differentiate from ICA." },
      { category: "Scanning Tip", text: "{\'tip_title\': \'Differentiating ICA from ECA\', \'tip_content\': \'The ECA has a higher-resistance wavefo" },
      { category: "Scanning Tip", text: "{\'tip_title\': \'Stenosis Measurement\', \'tip_content\': \'When measuring stenosis, the sample volume sho" }
    ],
  },
  {
    ...
    tips: [
      { category: "Patient Positioning", text: "Supine position with the head supported and turned away from the side being examined. A pillow may be placed under the shoulders to improve neck exten" },
      { category: "Transducer Positioning", text: "Longitudinal plane, in the mid-neck between transverse processes or at the origin" },
      { category: "What to Assess", text: "Flow direction and waveform." },
      { category: "Scanning Tip", text: "{\'tip_title\': \'Differentiating ICA from ECA\', \'tip_content\': \'The ECA has a higher-resistance wavefo" },
      { category: "Scanning Tip", text: "{\'tip_title\': \'Stenosis Measurement\', \'tip_content\': \'When measuring stenosis, the sample volume sho" }
    ],
  }
...
const generalTips = [
  { category: "Scanning Tip", text: "{\'tip_title\': \'Differentiating ICA from ECA\', \'tip_content\': \'The ECA has a higher-resistance waveform and branches in the neck, while the ICA has a l" },
  { category: "Scanning Tip", text: "{\'tip_title\': \'Stenosis Measurement\', \'tip_content\': \'When measuring stenosis, the sample volume should be placed at the point of maximal velocity. Wa" },
  { category: "Scanning Tip", text: "{\'tip_title\': \'Angle Correction\', \'tip_content\': \'Maintain a consistent angle of insonation between 45 and 60 degrees. The angle correction cursor sho" },
  { category: "Scanning Tip", text: "{\'tip_title\': \'Near Occlusion vs. Total Occlusion\', \'tip_content\': \"Use power Doppler and a low-flow scale to look for a \'string sign\' in cases of sus" }
];
    ...
    <Layout>
      ...
      <div className="container py-6">
        ...
        <div className="text-xs text-gray-400 px-1 mt-4">
          Based on: <a href="https://www.aium.org/resources/practice-parameters" target="_blank" rel="noopener noreferrer" className="underline hover:text-[#189aa1]">AIUM Practice Parameter for the Performance of an Ultrasound Examination of the Extracranial Cerebrovascular System (2021)</a>
        </div>
      </div>
    </Layout>
  );
