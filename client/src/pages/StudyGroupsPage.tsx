      ...
      <div className="min-h-screen overflow-hidden bg-[#f7fbfb]">
        ...
        <main className="mx-auto max-w-6xl px-4 py-14 sm:px-6 lg:px-8">
          ...
          <div className="grid gap-5 md:grid-cols-3">
            ...
            <Card className="border-teal-300 bg-white shadow-sm"><CardHeader><Crown className="h-6 w-6 text-teal-600" /><CardTitle className="mt-3">Lead a learning community</CardTitle><CardDescription>Organization Access from $49/month.</CardDescription></CardHeader><CardContent className="space-y-4 text-sm text-slate-600"><p>Build and manage your organization’s own learning content within this platform—from group modules to TEACH activities—then give members a high-touch experience that keeps everyone engaged and moving toward the next milestone.</p><Button className="w-full bg-teal-700 hover:bg-teal-800" onClick={() => navigate("/login?returnTo=/study-groups")}>Choose Organization Access</Button></CardContent></Card>
        ...
        <Dialog open={groupOptionsOpen} onOpenChange={setGroupOptionsOpen}>
          <DialogContent className="w-[calc(100vw-1rem)] !max-w-6xl border-teal-100 bg-[#fbffff] p-0 overflow-hidden sm:w-[calc(100vw-2rem)]">
            ...
            <div className="grid gap-4 p-5 sm:p-6 min-[700px]:grid-cols-3">
    ...
    <div className="min-h-screen bg-slate-50 pb-16">
      ...
      <main className="mx-auto max-w-6xl px-4 py-8 sm:px-6 lg:px-8">
        <div className="grid gap-5 md:grid-cols-3">
          ...
          <Card className="border-teal-300 bg-white"><CardHeader className="pb-3"><Crown className="h-5 w-5 text-teal-600" /><CardTitle className="text-base">Lead a learning community</CardTitle></CardHeader><CardContent className="space-y-4 text-sm text-slate-600"><p>Create and manage your own learning content within this platform, including group modules and TEACH activities, with Organization Access from ${((pricing?.organizationUpToTwentyMonthlyCents ?? 4900) / 100).toFixed(2)}/month.</p><Button className="w-full bg-teal-700 hover:bg-teal-800" onClick={() => beginAccessSignup("organization")}><Building2 className="mr-2 h-4 w-4" />Choose Organization Access</Button></CardContent></Card>
