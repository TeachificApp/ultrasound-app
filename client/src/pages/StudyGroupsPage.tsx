      ...
      <div className="min-h-screen overflow-hidden bg-[#f7fbfb]">
        ...
        <main className="mx-auto max-w-6xl px-4 py-14 sm:px-6 lg:px-8">
          ...
          <div className="grid gap-5 md:grid-cols-3">
            ...
            <Card className="border-teal-300 bg-white shadow-sm"><CardHeader><Crown className="h-6 w-6 text-teal-600" /><CardTitle className="mt-3">Lead a learning community</CardTitle><CardDescription>Organization Access from $49/month.</CardDescription></CardHeader><CardContent className="space-y-4 text-sm text-slate-600"><p>Build and manage your organization’s own group learning content, then give members a high-touch experience that keeps everyone engaged, aligned, and moving toward the next milestone.</p><Button className="w-full bg-teal-700 hover:bg-teal-800" onClick={() => navigate("/login?returnTo=/study-groups")}>Choose Organization Access</Button></CardContent></Card>
    ...
    <div className="min-h-screen bg-slate-50 pb-16">
      ...
      <main className="mx-auto max-w-6xl px-4 py-8 sm:px-6 lg:px-8">
        <div className="grid gap-5 md:grid-cols-3">
          ...
          <Card className="border-teal-300 bg-white"><CardHeader className="pb-3"><Crown className="h-5 w-5 text-teal-600" /><CardTitle className="text-base">Lead a learning community</CardTitle></CardHeader><CardContent className="space-y-4 text-sm text-slate-600"><p>Build and manage your own group learning content, then give your people a standout learning experience with Organization Access from ${((pricing?.organizationUpToTwentyMonthlyCents ?? 4900) / 100).toFixed(2)}/month.</p><Button className="w-full bg-teal-700 hover:bg-teal-800" onClick={() => beginAccessSignup("organization")}><Building2 className="mr-2 h-4 w-4" />Choose Organization Access</Button></CardContent></Card>
