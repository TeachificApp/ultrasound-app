...
export const CARDIAC_VIEWS = [
  {
    ...
    description: "The PLAX view is the standard starting position for cardiac POCUS. It provides excellent visualization of LV systolic function, LV size, mitral valve, aortic root, and posterior pericardial effusion. EPSS measured here correlates with EF.",
    howToGet: [
    ...
    pitfalls: [
      "Foreshortened LV underestimates cavity size — tilt probe to maximize LV length",
  ...
  },
  {
    ...
    howToGet: [
      ...
      "Tilt probe slightly to optimize MV visualization",
  ...
  },
  {
    ...
    howToGet: [
      ...
      "Avoid foreshortening — tilt probe to maximize LV length",
  ...
  return (
    <Layout>
      <div className="flex items-center justify-between px-4 py-2.5 border-b border-gray-100 bg-white">
        ...
        <Link href="/pocus-cardiac-navigator">
