/**
 * CohortSessionsEmbed.tsx
 * Standalone iframe-embeddable page that renders the live sessions calendar
 * for a specific cohort group.
 *
 * Route: /embed/cohort-sessions/:groupId
 * Query params:
...
export default function CohortSessionsEmbed() {
