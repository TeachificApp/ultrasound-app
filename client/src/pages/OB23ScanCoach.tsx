...
const views = [
  {
    ...
    probe: "Not specified",
    tips: [
      { category: "Patient Positioning", text: "Not explicitly stated in the document. The examination uses transabdominal and/or transvaginal approach." },
      { category: "Transducer Positioning", text: "Not specified" },
      { category: "What to Assess", text: "Lateral cerebral ventricles, Choroid plexus, Midline falx, Cavum septi pellucidi, Cerebellum, Cisterna magna, 3rd ventricle, 4th ventricle, Lateral ventricular wall integrity, contour, ependymal linin" },
      { category: "Scanning Tip", text: "{\'tip_title\': \'ALARA Principle\', \'tip_content\': \'The ALARA (as low as reasonably achievable) princip" }
    ],
  },
  {
    view: "Face",
    ...
    tips: [
      { category: "Patient Positioning", text: "Not explicitly stated in the document. The examination uses transabdominal and/or transvaginal approach." },
      { category: "Transducer Positioning", text: "Not specified" },
      { category: "What to Assess", text: "Upper lip, Profile, Nasal bone (15–22 wk), Coronal face (nose/lips/lens), Palate, maxilla, mandible, and tongue, Ear position and size, Orbits" },
      { category: "Scanning Tip", text: "{\'tip_title\': \'ALARA Principle\', \'tip_content\': \'The ALARA (as low as reasonably achievable) princip" }
    ],
  },
  {
    ...
    tips: [
      { category: "Patient Positioning", text: "Not explicitly stated in the document. The examination uses transabdominal and/or transvaginal approach." },
      { category: "Transducer Positioning", text: "Not specified" },
      { category: "What to Assess", text: "Heart: Cardiac activity, 4-chamber view, Left ventricular outflow tract, Right ventricular outflow tract, 3-vessel view (if technically feasible), 3-vessel and trachea view (if technically feasible), " },
      { category: "Scanning Tip", text: "{\'tip_title\': \'ALARA Principle\', \'tip_content\': \'The ALARA (as low as reasonably achievable) princip" }
    ],
  },
  {
    ...
    tips: [
      { category: "Patient Positioning", text: "Not explicitly stated in the document. The examination uses transabdominal and/or transvaginal approach." },
      { category: "Transducer Positioning", text: "Not specified" },
      { category: "What to Assess", text: "Stomach (presence, size, and situs), Kidneys, Urinary bladder, Cord insertion site into fetal abdomen, Umbilical cord vessel number, Small and large bowel, Adrenal glands, Gallbladder, Liver, Renal ar" },
      { category: "Scanning Tip", text: "{\'tip_title\': \'ALARA Principle\', \'tip_content\': \'The ALARA (as low as reasonably achievable) princip" }
    ],
  },
  {
    ...
    tips: [
      { category: "Patient Positioning", text: "Not explicitly stated in the document. The examination uses transabdominal and/or transvaginal approach." },
      { category: "Transducer Positioning", text: "Not specified" },
      { category: "What to Assess", text: "Cervical, Thoracic, Lumbar, Sacral spine, Integrity of spine and overlying soft tissue, Shape, curvature, conus medullaris" },
      { category: "Scanning Tip", text: "{\'tip_title\': \'ALARA Principle\', \'tip_content\': \'The ALARA (as low as reasonably achievable) princip" }
    ],
  },
  {
    ...
    tips: [
      { category: "Patient Positioning", text: "Not explicitly stated in the document. The examination uses transabdominal and/or transvaginal approach." },
      { category: "Transducer Positioning", text: "Not specified" },
      { category: "What to Assess", text: "Legs, Arms, Hands, Feet, Number, architecture, and position of extremities, Digits of hands and feet: number and position" },
      { category: "Scanning Tip", text: "{\'tip_title\': \'ALARA Principle\', \'tip_content\': \'The ALARA (as low as reasonably achievable) princip" }
    ],
  },
  {
    ...
    tips: [
      { category: "Patient Positioning", text: "Not explicitly stated in the document. The examination uses transabdominal and/or transvaginal approach." },
      { category: "Transducer Positioning", text: "Not specified" },
      { category: "What to Assess", text: "External genitalia" },
      { category: "Scanning Tip", text: "{\'tip_title\': \'ALARA Principle\', \'tip_content\': \'The ALARA (as low as reasonably achievable) princip" }
    ],
  },
  {
    ...
    tips: [
      { category: "Patient Positioning", text: "Not explicitly stated in the document. The examination uses transabdominal and/or transvaginal approach." },
      { category: "Transducer Positioning", text: "Not specified" },
      { category: "What to Assess", text: "Location, Relationship to internal os, Appearance, Placental cord insertion, Masses, Accessory/succenturiate lobe with location of connecting vascular supply to primary placenta and internal cervical " },
      { category: "Scanning Tip", text: "{\'tip_title\': \'ALARA Principle\', \'tip_content\': \'The ALARA (as low as reasonably achievable) princip" }
    ],
  },
  {
    ...
    tips: [
      { category: "Patient Positioning", text: "Not explicitly stated in the document. The examination uses transabdominal and/or transvaginal approach." },
      { category: "Transducer Positioning", text: "Not specified" },
      { category: "What to Assess", text: "Qualitative or semiquantitative estimate of amniotic fluid" },
      { category: "Scanning Tip", text: "{\'tip_title\': \'ALARA Principle\', \'tip_content\': \'The ALARA (as low as reasonably achievable) princip" }
    ],
  },
  {
    ...
    tips: [
      { category: "Patient Positioning", text: "Not explicitly stated in the document. The examination uses transabdominal and/or transvaginal approach." },
      { category: "Transducer Positioning", text: "Not specified" },
      { category: "What to Assess", text: "Fetal weight estimate" },
      { category: "Scanning Tip", text: "{\'tip_title\': \'ALARA Principle\', \'tip_content\': \'The ALARA (as low as reasonably achievable) princip" }
    ],
  },
  {
    ...
    tips: [
      { category: "Patient Positioning", text: "Not explicitly stated in the document. The examination uses transabdominal and/or transvaginal approach." },
      { category: "Transducer Positioning", text: "Not specified" },
      { category: "What to Assess", text: "Cervix (transvaginal when indicated), Uterus, Adnexa" },
      { category: "Scanning Tip", text: "{\'tip_title\': \'ALARA Principle\', \'tip_content\': \'The ALARA (as low as reasonably achievable) princip" }
    ],
  }
];
...
const examTips = [
  { category: "Scanning Tip", text: "{\'tip_title\': \'ALARA Principle\', \'tip_content\': \'The ALARA (as low as reasonably achievable) principle should be observed when adjusting controls that" }
];
