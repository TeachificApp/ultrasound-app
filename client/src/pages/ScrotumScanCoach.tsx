...
const views = [
  {
    ...
    tips: [
      { category: "Patient Positioning", text: "The patient is typically in a supine position. Upright positioning may be used to increase the sensitivity for detecting varicoceles, especially durin" },
      { category: "Transducer Positioning", text: "Transverse, coronal, or coronal oblique" },
      { category: "What to Assess", text: "Presence of two testes" },
      { category: "Scanning Tip", text: "{\'tip_title\': \'Optimize Imaging\', \'tip_content\': \'Use a copious amount of gel to improve imaging. A " },
      { category: "Scanning Tip", text: "{\'tip_title\': \'Pain Management\', \'tip_content\': \'In cases of acute swelling or pain, note the presen" }
    ],
  },
  {
    view: "Testis",
    ...
    tips: [
      { category: "Patient Positioning", text: "The patient is typically in a supine position. Upright positioning may be used to increase the sensitivity for detecting varicoceles, especially durin" },
      { category: "Transducer Positioning", text: "Longitudinal and Transverse" },
      { category: "What to Assess", text: "Size, echogenicity, and blood flow of each testis. Evaluate in superior, mid, and inferior portions (transverse) and centrally, medially, and laterally (longitudinal)." },
      { category: "Scanning Tip", text: "{\'tip_title\': \'Optimize Imaging\', \'tip_content\': \'Use a copious amount of gel to improve imaging. A " },
      { category: "Scanning Tip", text: "{\'tip_title\': \'Pain Management\', \'tip_content\': \'In cases of acute swelling or pain, note the presen" }
    ],
  },
  {
    ...
    tips: [
      { category: "Patient Positioning", text: "The patient is typically in a supine position. Upright positioning may be used to increase the sensitivity for detecting varicoceles, especially durin" },
      { category: "Transducer Positioning", text: "Longitudinal and Transverse" },
      { category: "What to Assess", text: "Head, body, and tail of the epididymis for size, echogenicity, and blood flow." },
      { category: "Scanning Tip", text: "{\'tip_title\': \'Optimize Imaging\', \'tip_content\': \'Use a copious amount of gel to improve imaging. A " },
      { category: "Scanning Tip", text: "{\'tip_title\': \'Pain Management\', \'tip_content\': \'In cases of acute swelling or pain, note the presen" }
    ],
  },
  {
    ...
    tips: [
      { category: "Patient Positioning", text: "The patient is typically in a supine position. Upright positioning may be used to increase the sensitivity for detecting varicoceles, especially durin" },
      { category: "Transducer Positioning", text: "Transverse and Longitudinal" },
      { category: "What to Assess", text: "Evaluate for signs of torsion." },
      { category: "Scanning Tip", text: "{\'tip_title\': \'Optimize Imaging\', \'tip_content\': \'Use a copious amount of gel to improve imaging. A " },
      { category: "Scanning Tip", text: "{\'tip_title\': \'Pain Management\', \'tip_content\': \'In cases of acute swelling or pain, note the presen" }
    ],
  },
  {
    ...
    tips: [
      { category: "Patient Positioning", text: "The patient is typically in a supine position. Upright positioning may be used to increase the sensitivity for detecting varicoceles, especially durin" },
      { category: "Transducer Positioning", text: "Transverse and Longitudinal" },
      { category: "What to Assess", text: "Evaluate the scrotal wall and overlying skin." },
      { category: "Scanning Tip", text: "{\'tip_title\': \'Optimize Imaging\', \'tip_content\': \'Use a copious amount of gel to improve imaging. A " },
      { category: "Scanning Tip", text: "{\'tip_title\': \'Pain Management\', \'tip_content\': \'In cases of acute swelling or pain, note the presen" }
    ],
  }
...
const examTips = [
  { category: "Scanning Tip", text: "{\'tip_title\': \'Optimize Imaging\', \'tip_content\': \'Use a copious amount of gel to improve imaging. A standoff pad may also be helpful.\', \'pitfall\': \'Po" },
  { category: "Scanning Tip", text: "{\'tip_title\': \'Pain Management\', \'tip_content\': \'In cases of acute swelling or pain, note the presence or absence of pain before beginning the scan. C" },
  { category: "Scanning Tip", text: "{\'tip_title\': \'Varicocele Detection\', \'tip_content\': \'Scan the patient in an upright position and use the Valsalva maneuver to increase the sensitivit" },
  { category: "Scanning Tip", text: "{\'tip_title\': \'Undescended Testis\', \'tip_content\': \'If a testis is not identified within the scrotum, scan the ipsilateral inguinal canal, inguinal ri" }
];
          ...
          <div className="flex items-start gap-4">
            ...
            <div className="flex-1">
              ...
              <p className="text-white/70 text-xs mt-1 max-w-xl">
                Probe: 12-MHz or higher linear array transducer. A lower frequency (5-10 MHz) curved or linear transducer m
              </p>
              <div className="mt-3">
