...
const views = [
  {
    ...
    items: [
    { id: "venousnavigator_0_0", label: "Compressibility, spectral Doppler waveform for symmetry and respiratory phasicit", detail: "", critical: false }
    ],
  },
  {
    ...
    items: [
    { id: "venousnavigator_1_0", label: "Compressibility every 2 cm", detail: "", critical: false }
    ],
  },
  {
    ...
    items: [
    { id: "venousnavigator_2_0", label: "Compressibility", detail: "", critical: false }
    ],
  },
  {
    ...
    items: [
    { id: "venousnavigator_3_0", label: "Compressibility", detail: "", critical: false }
    ],
  },
  {
    view: "Popliteal Vein",
    ...
    items: [
    { id: "venousnavigator_4_0", label: "Compressibility, spectral Doppler waveform", detail: "", critical: false }
    ],
  },
  {
    ...
    items: [
    { id: "venousnavigator_5_0", label: "Compressibility", detail: "", critical: false }
    ],
  },
  {
    view: "Peroneal Veins",
    probe: "Transverse, from popliteal fossa to ankle",
    items: [
    { id: "venousnavigator_6_0", label: "Compressibility", detail: "", critical: false }
    ],
  },
  {
    ...
    items: [
    { id: "venousnavigator_7_0", label: "Compressibility, especially if focal symptoms are present", detail: "", critical: false }
    ],
  }
];
