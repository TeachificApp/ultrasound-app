...
export default function PlatformAdmin() {
  ...
  const DUAL_TOOLS_DEFAULT: ToolCard[] = [
    ...
    { id: "question-bank", href: getAdminUrl("/question-bank"), icon: BookOpen, label: "Question Bank", description: "Browse, import (SCORM/CSV/XLSX), and manage the shared question bank used across all quizzes", color: "#7c3aed" },
