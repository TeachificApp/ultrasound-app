...
export default function PlatformAdmin() {
  ...
  const DUAL_TOOLS_DEFAULT: ToolCard[] = [
    ...
    { id: "study-groups", href: getAdminUrl("/admin/study-groups"), icon: Users, label: "Study Groups", description: "Review every private group, uploaded document, seat, activity record, and editable workspace content block", color: "#0f766e" },
