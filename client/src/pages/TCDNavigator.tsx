...
const views = [
  {
    ...
    items: [
    { id: "tcdnavigator_0_0", label: "Distal Internal Carotid Artery (ICA) and branches of the circle of Willis, peric", detail: "", critical: false }
    ],
  },
  {
    ...
    items: [
    { id: "tcdnavigator_1_0", label: "Assess Superior Sagittal Sinus (Infants)", detail: "Patency", critical: false }
    ],
  },
  {
    ...
    items: [
    { id: "tcdnavigator_2_0", label: "Posterior circulation vessels", detail: "", critical: false }
    ],
  },
  {
    ...
    items: [
    { id: "tcdnavigator_3_0", label: "Middle Cerebral Artery (MCA), Anterior Cerebral Artery (ACA), Posterior Cerebral", detail: "", critical: false }
    ],
  }
];
