/*
  UltrasoundAssist™ — Vascular Extracranial Carotid Artery Navigator
          ...
          <div className="flex items-start gap-4">
            ...
            <div className="flex-1">
              <div className="inline-flex items-center gap-2 bg-white/10 border border-white/20 rounded-full px-3 py-1 mb-2">
                ...
                <span className="text-sm text-white/80 font-medium">Carotid · Protocol Navigator</span>
              </div>
              <h1 className="text-2xl md:text-3xl font-black text-white leading-tight" style={{ fontFamily: "Merriweather, serif" }}>
                Vascular Extracranial Carotid Artery Navigator
              </h1>
        ...
        {tab === "reference" && (
          <div className="space-y-3">
            ...
            <div className="text-xs text-gray-400 px-1">
              Reference: <a href="https://www.aium.org/resources/practice-parameters" target="_blank" rel="noopener noreferrer" className="underline hover:text-[#189aa1]">AIUM Practice Parameter for the Performance of an Ultrasound Examination of the Extracranial Cerebrovascular System (2021)</a>
            </div>
          </div>
        )}
