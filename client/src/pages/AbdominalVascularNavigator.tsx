/*
  UltrasoundAssist™ — Vascular - Native Renal Vessels Navigator
...
const views = [
  {
    ...
    probe: "Flank/Abdomen",
    items: [
    { id: "abdominalvascularnavigator_0_0", label: "Longest renal length, parenchymal echotexture and thickness", detail: "", critical: false }
    ],
  },
  {
    view: "Aorta",
    ...
    items: [
    { id: "abdominalvascularnavigator_1_0", label: "Longitudinal and transverse views at the level of the renal arteries and above", detail: "", critical: false },
    { id: "abdominalvascularnavigator_1_1", label: "PSV measurement", detail: "", critical: false }
    ],
  },
  {
    ...
    items: [
    { id: "abdominalvascularnavigator_2_0", label: "PSV at origin, proximal, mid, and distal segments", detail: "", critical: false },
    { id: "abdominalvascularnavigator_2_1", label: "Search for accessory arteries", detail: "", critical: false }
    ],
  },
  {
    ...
    probe: "Flank/Abdomen",
    items: [
    { id: "abdominalvascularnavigator_3_0", label: "Spectral Doppler waveforms from segmental, interlobar, or arcuate arteries in th", detail: "", critical: false }
    ],
  },
  {
    view: "Renal Veins",
    probe: "Abdomen/Flank",
    items: [
    { id: "abdominalvascularnavigator_4_0", label: "Grayscale and color Doppler longitudinal views of the main renal veins with spec", detail: "", critical: false }
    ],
  }
];
          ...
          <div className="flex items-start gap-4">
            ...
            <div className="flex-1">
              ...
              <h1 className="text-2xl md:text-3xl font-black text-white leading-tight" style={{ fontFamily: "Merriweather, serif" }}>
                Vascular - Native Renal Vessels Navigator
              </h1>
              ...
              <p className="text-white/60 text-xs mt-1 max-w-xl">
                Positioning: The patient is typically examined in the supine position. Oblique or decubitus positions may be used to optimize visualization of the renal arteries.
              </p>
              <div className="mt-3">
                <Link href="/abdominal-vascular-scan-coach">
                  <button
        ...
        {tab === "reference" && (
          <div className="space-y-3">
            ...
            <div className="text-xs text-gray-400 px-1">
              Reference: <a href="https://www.aium.org/resources/practice-parameters" target="_blank" rel="noopener noreferrer" className="underline hover:text-[#189aa1]">AIUM Practice Parameter for the Performance of an Ultrasound Examination of the Abdominal Aorta (2021)</a>
            </div>
          </div>
        )}
