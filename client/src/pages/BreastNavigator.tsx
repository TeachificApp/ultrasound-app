...
const views = [
  {
    ...
    items: [
    { id: "breastnavigator_0_0", label: "Lesion size (3 orthogonal planes), shape, orientation, margins, echo pattern, po", detail: "", critical: false },
    { id: "breastnavigator_0_1", label: "Correlate with clinical signs/symptoms and other imaging studies", detail: "", critical: false },
    { id: "breastnavigator_0_2", label: "View in 2 orthogonal projections", detail: "", critical: false }
    ],
  },
  {
    ...
    items: [
    { id: "breastnavigator_1_0", label: "Size, shape, cortical thickness, margin, hilar compression or displacement, BI-R", detail: "", critical: false },
    { id: "breastnavigator_1_1", label: "Evaluate for lymphadenopathy", detail: "", critical: false }
    ],
  }
];
          ...
          <div className="flex items-start gap-4">
            ...
            <div className="flex-1">
              ...
              <p className="text-white/70 text-sm mt-2 max-w-xl leading-relaxed">
                Probe: High-resolution, real-time, linear-array transducer operating at a center frequency of at least 12 MHz. For larger breas
              </p>
              <p className="text-white/60 text-xs mt-1 max-w-xl">
                Positioning: The patient should be supine or in a slight oblique position with the ipsilateral arm abducted and elevated above the head. This position helps to fla
              </p>
              <div className="mt-3">
        ...
        {tab === "reference" && (
          <div className="space-y-3">
            ...
            <div className="text-xs text-gray-400 px-1">
              Reference: <a href="https://www.aium.org/resources/practice-parameters" target="_blank" rel="noopener noreferrer" className="underline hover:text-[#189aa1]">AIUM Practice Parameter for the Performance of a Breast Ultrasound Examination (2016)</a>
            </div>
          </div>
        )}
