...
const views = [
  {
    ...
    tips: [
      { category: "Patient Positioning", text: "The document does not specify patient positioning. Supine position is standard for transabdominal scans, and lithotomy position for transvaginal scans" },
      { category: "Transducer Positioning", text: "Transabdominal or transvaginal" },
      { category: "What to Assess", text: "Presence, location, and number of gestational sacs." },
      { category: "Scanning Tip", text: "{\'tip_title\': \'CRL Measurement\', \'tip_content\': \'Ensure the fetus is in a neutral position, not flex" },
      { category: "Scanning Tip", text: "{\'tip_title\': \'NT Measurement\', \'tip_content\': \'Magnify the image so the fetal head, neck, and upper" }
    ],
  },
  {
    view: "Embryo/Fetus",
    ...
    tips: [
      { category: "Patient Positioning", text: "The document does not specify patient positioning. Supine position is standard for transabdominal scans, and lithotomy position for transvaginal scans" },
      { category: "Transducer Positioning", text: "Transabdominal or transvaginal" },
      { category: "What to Assess", text: "Presence of embryo/fetus, cardiac activity." },
      { category: "Scanning Tip", text: "{\'tip_title\': \'CRL Measurement\', \'tip_content\': \'Ensure the fetus is in a neutral position, not flex" },
      { category: "Scanning Tip", text: "{\'tip_title\': \'NT Measurement\', \'tip_content\': \'Magnify the image so the fetal head, neck, and upper" }
    ],
  },
  {
    ...
    tips: [
      { category: "Patient Positioning", text: "The document does not specify patient positioning. Supine position is standard for transabdominal scans, and lithotomy position for transvaginal scans" },
      { category: "Transducer Positioning", text: "Transabdominal or transvaginal, midsagittal plane" },
      { category: "What to Assess", text: "The subcutaneous space between the skin and the cervical spine." },
      { category: "Scanning Tip", text: "{\'tip_title\': \'CRL Measurement\', \'tip_content\': \'Ensure the fetus is in a neutral position, not flex" },
      { category: "Scanning Tip", text: "{\'tip_title\': \'NT Measurement\', \'tip_content\': \'Magnify the image so the fetal head, neck, and upper" }
    ],
  },
  {
    ...
    tips: [
      { category: "Patient Positioning", text: "The document does not specify patient positioning. Supine position is standard for transabdominal scans, and lithotomy position for transvaginal scans" },
      { category: "Transducer Positioning", text: "Axial and sagittal planes" },
      { category: "What to Assess", text: "Calvarium, falx cerebri, choroid plexus, ventricles." },
      { category: "Scanning Tip", text: "{\'tip_title\': \'CRL Measurement\', \'tip_content\': \'Ensure the fetus is in a neutral position, not flex" },
      { category: "Scanning Tip", text: "{\'tip_title\': \'NT Measurement\', \'tip_content\': \'Magnify the image so the fetal head, neck, and upper" }
    ],
  }
...
const examTips = [
  { category: "Scanning Tip", text: "{\'tip_title\': \'CRL Measurement\', \'tip_content\': \'Ensure the fetus is in a neutral position, not flexed or extended. The entire embryo must be visible " },
  { category: "Scanning Tip", text: "{\'tip_title\': \'NT Measurement\', \'tip_content\': \'Magnify the image so the fetal head, neck, and upper thorax occupy the screen. The fetus should be in " }
];
