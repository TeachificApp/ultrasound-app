/**
 * CommunitySalesPageBuilder.tsx
 * Full-screen drag-and-drop WYSIWYG page editor.
 * Route: /admin/community/:communityId/sales-page-builder
 *
...
export default function CommunitySalesPageBuilder() {
    ...
    <div className="flex flex-col h-screen bg-gray-50 overflow-hidden">
      ...
      <div className="flex items-center justify-between px-4 py-2 bg-white border-b border-gray-200 shadow-sm flex-shrink-0">
        <div className="flex items-center gap-3">
          ...
          <div>
            <p className="text-xs text-gray-400">Community Sales Landing Page</p>
