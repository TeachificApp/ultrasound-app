...
const STATIC_CONTENT: Record<string, StaticViewContent> = {
  ...
  "tee:me_mc": {
    description: "Obtained by rotating the multiplane angle to 60–70° from the ME 4-chamber position. Displays both mitral commissures (ALC and PMC) simultaneously with P1/A2/P3 in a single plane. Key view for commissural MR localisation and MitraClip/TEER guidance.",
    structures: ["Mitral valve P1 (anterolateral)", "Mitral valve A2 (central)", "Mitral valve P3 (posteromedial)", "Anterolateral commissure (ALC)", "Posteromedial commissure (PMC)", "Left atrium", "Left ventricle"],
    howToGet: ["From ME 4-chamber at 0°, rotate multiplane angle to 60–70°", "Fine-tune between 55–75° to open both commissures simultaneously", "Apply slight anteflexion if valve plane is not fully visualised"],
    tips: ["Best view to identify P1 and P3 prolapse simultaneously", "Commissural MR jets confirmed here — ALC (P1/A1) vs PMC (P3/A3)", "For MitraClip/TEER: confirms clip perpendicular to coaptation line"],
    pitfalls: ["Angle varies 55–75° between patients — do not fix at exactly 60° without visual confirmation", "Commissural jet can appear central in other views — always interrogate at 60–70°"],
    measurements: ["MVA by planimetry (MS)", "Commissural width", "Vena contracta of commissural MR jet"],
    criticalFindings: ["Commissural MR jet", "Severe commissural fusion (rheumatic MS)", "Commissural leaflet tear or flail"],
  },
  "tee:tgbasal": {
    description: "Obtained by slightly withdrawing from TG Mid SAX while maintaining anteflexion. Images the LV at the mitral valve level (basal SAX), showing the mitral leaflets and subvalvular apparatus in cross-section. Key view for MV morphology, commissural anatomy, and MitraClip/TEER guidance.",
    structures: ["Mitral valve anterior leaflet (A1/A2/A3)", "Mitral valve posterior leaflet (P1/P2/P3)", "Anterolateral commissure (ALC)", "Posteromedial commissure (PMC)", "Mitral subvalvular apparatus", "LV basal cavity"],
    howToGet: ["From TG Mid SAX, slowly withdraw probe 1–2 cm while maintaining anteflexion", "Papillary muscles disappear and mitral leaflets come into view", "Fine-tune depth until both leaflets are fully visible in cross-section"],
    tips: ["Best view to map exact MR jet location within the mitral orifice", "'Fish-mouth' opening of MV confirms correct basal positioning", "3D acquisition from this window gives the classic en-face surgical view of the MV"],
    pitfalls: ["Over-withdrawal brings probe to LVOT level — confirm mitral (not AV) leaflets are in view", "Foreshortening of mitral orifice leads to overestimation of MVA by planimetry"],
    measurements: ["MVA by planimetry (MS)", "Mitral annulus diameter", "MR jet location within orifice"],
    criticalFindings: ["Commissural MR jet (ALC or PMC origin)", "Severe mitral stenosis (MVA <1.0 cm²)", "Flail or prolapsing leaflet scallop"],
  },
  "tee:tgsax": {
