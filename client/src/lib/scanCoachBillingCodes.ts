/**
 * scanCoachBillingCodes.ts
 *
 * CPT billing codes for each ScanCoach module / exam tab.
 * Codes are for reference only — always verify with current payer policies.
 */
...
export type ScanCoachBillingData = BillingSection[];
