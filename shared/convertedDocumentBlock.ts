export function isConvertedDocumentBlock(data: Record<string, unknown> | null | undefined) {
  ...
  if (data.pdfPage || data.pptxSlide) return true;
  if (data.sourceDocument) return true;
  const html = typeof data.html === "string" ? data.html : "";
  return html.includes("data-converted-document") || html.includes("data-pdf-page") || html.includes("data-pptx-slide-layout");
}
