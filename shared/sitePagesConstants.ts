...
export const SITE_PAGE_DOMAINS = [
  { value: "learn.allaboutultrasound.com", label: "Learn (AAUS)", brand: "aaus" as Brand },
  { value: "app.allaboutultrasound.com", label: "App (AAUS)", brand: "aaus" as Brand },
  { value: "members.allaboutultrasound.com", label: "Members (AAUS)", brand: "aaus" as Brand },
  { value: "allaboutultrasound.com", label: "Marketing (AAUS root)", brand: "aaus" as Brand },
  { value: "app.iheartecho.com", label: "App (iHeartEcho)", brand: "iheartecho" as Brand },
] as const;
