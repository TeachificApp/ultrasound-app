...
export const quickfireQuestions = mysqlTable("quickfireQuestions", {
  ...
  category: mysqlEnum("category", ["Abdominal", "Small Parts", "Pelvic/Gyn", "OB 1st Trimester", "OB 2nd/3rd Trimester", "Fetal Echo", "Breast", "Vascular", "MSK", "POCUS"]).default("Abdominal"),
...
export const quickfireChallenges = mysqlTable("quickfireChallenges", {
  ...
  category: mysqlEnum("category", ["Abdominal", "Small Parts", "Pelvic/Gyn", "OB 1st Trimester", "OB 2nd/3rd Trimester", "Fetal Echo", "Breast", "Vascular", "MSK", "POCUS"]).default("Abdominal").notNull(),
