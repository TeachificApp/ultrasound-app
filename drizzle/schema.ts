...
export const questionBankFolders = mysqlTable("question_bank_folders", {
  ...
  /** Optional parent-folder logo inherited by native Question Bank quiz questions. */
  quizLogoUrl: text("quiz_logo_url"),
  sortOrder: int("sort_order").default(0).notNull(),
...
export const cmeActivityForms = mysqlTable("cme_activity_forms", {
  ...
  originalReleaseDate: varchar("originalReleaseDate", { length: 128 }),
  mostRecentReviewDate: varchar("mostRecentReviewDate", { length: 128 }),
  expirationDate: varchar("expirationDate", { length: 128 }),
