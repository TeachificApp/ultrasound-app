      ...
      <table width="600" cellpadding="0" cellspacing="0" style="background:#ffffff;border-radius:12px;overflow:hidden;box-shadow:0 2px 8px rgba(0,0,0,0.08);">
        ...
        <tr><td style="background:linear-gradient(135deg,#0e1e2e,#0e4a50);padding:28px 32px;">
          <table width="100%" cellpadding="0" cellspacing="0">
            <tr>
              <td>
                <p style="margin:0;font-size:20px;font-weight:700;color:#ffffff;font-family:Merriweather,Georgia,serif;">All About Ultrasound™</p>
        ...
        <tr><td style="padding:32px;">
          ...
          <a href="${process.env.VITE_APP_URL || 'https://app.allaboutultrasound.com'}/accreditation-manager" style="display:inline-block;padding:12px 24px;background:#189aa1;color:#ffffff;font-size:14px;font-weight:600;text-decoration:none;border-radius:8px;" target="_blank" rel="noopener noreferrer">View Task</a>
        </td></tr>
        <!-- Footer -->
